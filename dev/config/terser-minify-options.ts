import type { MinifyOptions as TerserMinifyOptions, SourceMapOptions as TerserSourceMapOptions } from 'terser'
import { knownPureFunctionsNames } from './browser-globals'
...
export function getTerserMinifyOptions(
  ...
  terserNameCache?: Record<any, any>
): TerserMinifyOptions {
  ...
  return {
    ...
    // Sourcemap support
    sourceMap: settings.sourceMap || false,
    ...
    compress: {
      ...
      pure_funcs: knownPureFunctionsNames,
