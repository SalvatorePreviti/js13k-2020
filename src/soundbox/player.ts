...
import { sin, random } from '../math/scalar'
...
// Oscillators
const osc_sin = (value: number) => sin(value * 6.283184)
...
const getnotefreq = (n: number) => 0.003959503758 * 2 ** ((n - 128) / 12) // 174.61.. / 44100 = 0.003959503758 (F3)
...
const mOscillators = [osc_sin, osc_square, osc_tri /*osc_saw*/, osc_tri]
...
export const musicGenerate = function () {
  // Local variables
  let i
  let j
  let p
...
export const musicCreateWave = function () {
  // Create WAVE header
  const headerLen = 44
